package com.example.springbootsecurityjwtauth.filter;
...
import com.example.springbootsecurityjwtauth.jwt.JwtAuthHelper;
...
/**
 * I prefer Filter to handle login action, you can create
 * rest controller with /login end-point instead.
 */
